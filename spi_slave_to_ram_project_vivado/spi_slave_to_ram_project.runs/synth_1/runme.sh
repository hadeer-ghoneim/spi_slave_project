...
HD_PWD='C:/Users/General/Desktop/.github/vivado/spi_slave_to_ram_project/spi_slave_to_ram_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_TOP.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPI_TOP.tcl
