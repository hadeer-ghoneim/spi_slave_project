...
HD_PWD='C:/Users/General/Desktop/.github/vivado/spi_slave_to_ram_project/spi_slave_to_ram_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log SPI_TOP.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source SPI_TOP.tcl -notrace
